...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Laravel Meili Search</title>
                ...
                <div class="space-y-4 ">
                    ...
                    <div>
                        <h2 class="text-lg font-bold">
                            {{ $result->name }}
                            <p class="text-sm text-gray-600 font-base"> {{ $result->description }}</p>
                        </h2>
                    </div>
                    @empty
                        <p class="text-xl font-bold">No results</p>
                    @endforelse
                  </div>
